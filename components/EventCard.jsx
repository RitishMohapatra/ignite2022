...
export default function EventCard({
	...
	return (
        ...
        <>
          <div
            className="sm:p-5 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
          >
            <div className="relative w-auto my-6 mx-auto max-w-6xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae fugiat aut libero quasi nisi eos illo, maiores voluptatum voluptates doloremque.
				  </p>
                </div>
                {/*footer*/}
		...
		<div
			...
			<div className='p-1 lg:p-3 flex flex-row items-center transform transition-all duration-300 group-hover:rotate-3 relative'>
				...
				<button  onClick={() => setShowModal(true)} className='absolute bottom-2 right-2 px-3 py-2 flex flex-row items-center gap-x-1 bg-white bg-opacity-20 hover:bg-opacity-30 transition-all duration-300 rounded-lg'>
